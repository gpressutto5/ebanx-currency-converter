...
class Front
{
    ...
    public function enqueue_styles()
    {
        wp_enqueue_style($this->ebanx_currency_converter,
            plugin_dir_url(__FILE__) . 'dist/css/ebanx-currency-converter-public.min.css', array(), $this->version,
            'all');
    }
    ...
    public function enqueue_scripts()
    {
        wp_enqueue_script($this->ebanx_currency_converter,
            plugin_dir_url(__FILE__) . 'dist/js/ebanx-currency-converter-public.min.js', array('jquery'),
            $this->version, false);
